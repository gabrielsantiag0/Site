...
?>
    <!-- receita -->
    <main class="container mt-5 border border-1 border-black bg-white rounded-2 mb-4">
      <!-- receita crianças  -->
      <section>
        <div class="row m-4">
            <h1>
        ...
        <div class="row d-flex justify-content-evenly">
            ...
            <div class="col text-end">
              <a class="nav-link" href="ReceitasCriancas.php">VER MAIS RECEITAS PARA CRIANÇAS &rarr; </a>
            </div>
        </div>
     ...
     <section>
      <div class="row d-flex justify-content-evenly mt-5">
          ...
          <div class="col d-none">2</div>
          <div class="col text-end">
            <a class="nav-link" href="ReceitasLanches.php">VER MAIS RECEITAS DE LANCHES &rarr; </a>
          </div>
      </div>
      <div class="row mt-3 text-center">
          <div class="col">
         <a href="./ReceitasLanches/SaladaFrutaComPêssego.php">
    ...
    <section>
      <div class="row d-flex justify-content-evenly mt-5">
          ...
          <div class="col d-none">2</div>
          <div class="col text-end">
            <a class="nav-link" href="ReceitasDoce.php">VER MAIS RECEITAS DE DOCES &rarr; </a>
          </div>
      </div>
      <div class="row mt-3 text-center">
          <div class="col">
    ...
    <!-- receitas refeições -->
     <section>
      <div class="row d-flex justify-content-evenly mt-5">
          ...
          <div class="col d-none">2</div>
          <div class="col text-end">
            <a class="nav-link" href="ReceitasRefeicoes.php">VER MAIS RECEITAS DE REFEIÇÕES &rarr; </a>
          </div>
      </div>
      <div class="row mt-3 text-center">
          <div class="col">
    ...
    <section>
      <div class="row d-flex justify-content-evenly mt-5">
          ...
          <div class="col d-none">2</div>
          <div class="col text-end">
            <a class="nav-link" href="ReceitasPascoa.php">VER MAIS RECEITAS DE PÁSCOA &rarr; </a>
          </div>
      </div>
      <div class="row mt-3 text-center">
          <div class="col">
            <a href="./RefeicoesPascoa/Brigadeirão.php">
              <img src="Img/brigadeirao.jpg" alt="Brigadeirão" width="250px">
            </a>
            <h4 class="m-3">Brigadeirão</h4>
          </div>
          <div class="col">
            <a href="./RefeicoesPascoa/CassataSiciliana.php">
              <img src="Img/CassataSiciliana.jpg" alt="Cassata Siciliana" width="250px" >
            </a>
            <h4 class="m-3">Cassata Siciliana</h4>
          </div>
          <div class="col">
            <a href="./RefeicoesPascoa/EnroladoDeChocolate.php">
    ...
    <section>
      <div class="row d-flex justify-content-evenly mt-5">
          ...
          <div class="col d-none">2</div>
          <div class="col text-end">
            <a class="nav-link" href="ReceitasJunina.php">VER MAIS RECEITAS DE  FESTA DE FIM DE ANO &rarr; </a>
          </div>
      </div>
      <div class="row mt-3 text-center">
          <div class="col">
    ...
    <section>
      <div class="row d-flex justify-content-evenly mt-5">
          ...
          <div class="col d-none">2</div>
          <div class="col text-end">
            <a class="nav-link" href="ReceitasFimDeAno.php">VER MAIS RECEITAS DE  FESTA DE FIM DE ANO &rarr; </a>
          </div>
      </div>
      <div class="row mt-3 text-center">
          <div class="col">
            <a href="./ReceitaFimDeAno/PavêDeSorveteComBrownie.php">
              <img src="Img/PavêDeSorveteComBrownie.jpg" alt="Pavê de Sorvete com Brownie" width="250px">
            </a>
            <h4 class="m-3">Pavê de Sorvete com Brownie</h4>
          </div>
          <div class="col">
            <a href="./ReceitaFimDeAno/ChristmasCake.php">
              <img src="Img/ChristmasCake.jpg" alt="Christmas Cake" width="250px" >
            </a>
            <h4 class="m-3">Christmas Cake</h4>
          </div>
          <div class="col">
            <a href="./ReceitaFimDeAno/BavaroiseDeLimão.php">
